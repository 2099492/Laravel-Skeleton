    ...
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div>
                ...
                <x-jet-input id="initials" class="block mt-1 w-full" type="text" name="initials" :value="old('initials')" required autofocus autocomplete="initials" />
            </div>
            ...
            <div>
                ...
                <x-jet-input id="infix" class="block mt-1 w-full" type="text" name="infix" :value="old('infix')" required autofocus autocomplete="infix" />
            </div>
            ...
            <div>
                ...
                <x-jet-input id="postal_code" class="block mt-1 w-full" type="text" name="postal_code" :value="old('postal_code')" required autofocus autocomplete="postal_code" />
            </div>
